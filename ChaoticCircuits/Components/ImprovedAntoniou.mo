...
model ImprovedAntoniou "Improved Antoniou simulated inductance"
  ...
  ImprovedOpAmp3Pin opAmp1(
    Vps=+Vs,
    Vns=-Vs,
    useFirstOrder=true) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-50,-30})));
  ImprovedOpAmp3Pin opAmp2(
    Vps=+Vs,
    Vns=-Vs,
    useFirstOrder=true) annotation (Placement(transformation(
        extent={{10,10},{-10,-10}},
...
equation
  ...
  annotation (Icon(graphics={
        Line(points={{60,0},{90,0}}, color={255,0,128}),
        Line(points={{-90,0},{-60,0}}, color={255,0,128}),
        Line(
