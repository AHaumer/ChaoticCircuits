...
model InductorlessCircuit "Chua's chaotic Circuit"
  ...
  SI.Voltage v2=capacitor2.v "Result c2.v";
  ...
  parameter SI.Voltage v90=0 "Initial voltage of c9";
  ...
  Modelica.Electrical.Analog.Basic.Resistor r9(R=R9)
    annotation (Placement(
        ...
        rotation=270,
        origin={-50,0})));
  Modelica.Electrical.Analog.Basic.Capacitor c9(v(fixed=true, start=v90), C=C9)
