...
model ImprovedCircuit "van der Pol equations"
  ...
  Components.IdealizedOpAmp3Pin integrator_z
  ...
  Components.IdealizedOpAmp3Pin integrator_x
    annotation (Placement(transformation(extent={{50,-10},{70,10}})));
  Modelica.Electrical.Analog.Basic.Ground ground3
    annotation (Placement(transformation(extent={{44,-22},{56,-10}})));
  Modelica.Electrical.Analog.Basic.Capacitor c_x(v(fixed=true, start=-x0/kx), C=C)
    annotation (Placement(transformation(extent={{70,10},{50,30}})));
  Modelica.Electrical.Analog.Basic.Resistor rzx(R=Rzx)
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  Components.IdealizedOpAmp3Pin add_y
  ...
  Components.IdealizedOpAmp3Pin add_1x2
...
protected
  ...
  SI.Current ryz_i_p(start=0) =ryz.p.i;
equation
